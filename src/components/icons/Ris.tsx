...
const SvgRis = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <style>{".ris_svg__cls-2{fill:#08f}.ris_svg__cls-3{fill:#fff}"}</style>
    </defs>
    <g id="ris_svg__Ebene_2" data-name="Ebene 2">
      <g id="ris_svg__Ebene_1-2" data-name="Ebene 1">
        <path
